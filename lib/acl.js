...
/**
  whichRoles(resource, function(err, {resourceName: [permissions]})
  Returns which roles have permission over given resource.
  whichRoles(role, permissions, function(err, resources) )
  Returns which roles have given permission over a resource.
  
  @param {String} Resource
  @param {String} Permissions
  @param {Function} Callback called wish the result.
*/
Acl.prototype.whichRoles = function (resource, permissions, cb) {
  contract(arguments)
    .params('string')
    .params('string', 'string|array')
    .params('string', 'function')
  ...
  return this.permittedRoles(resource, permissions, cb);
};

Acl.prototype.permittedRoles = function (resource, permissions, cb) {
  var _this = this;
  var result = _.isUndefined(permissions) ? {} : [];
